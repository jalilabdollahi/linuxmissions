# Tar Extract: Alert Filter

## What you practiced
- This level focused on **Tar Extract** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in tar-extract.log.
