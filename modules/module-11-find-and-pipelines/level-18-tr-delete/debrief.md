# Tr Delete: Alert Filter

## What you practiced
- This level focused on **Tr Delete** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in tr-delete.log.
