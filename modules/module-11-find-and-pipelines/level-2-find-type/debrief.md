# Find Type: Alert Filter

## What you practiced
- This level focused on **Find Type** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in find-type.log.
