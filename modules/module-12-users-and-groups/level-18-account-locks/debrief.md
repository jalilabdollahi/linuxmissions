# Account Locks: Alert Filter

## What you practiced
- This level focused on **Account Locks** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in account-locks.log.
