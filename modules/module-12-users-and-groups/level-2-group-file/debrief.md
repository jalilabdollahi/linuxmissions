# Group File: Alert Filter

## What you practiced
- This level focused on **Group File** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in group-file.log.
