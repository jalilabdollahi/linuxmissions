# Systemctl Enable: Alert Filter

## What you practiced
- This level focused on **Systemctl Enable** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in systemctl-enable.log.
