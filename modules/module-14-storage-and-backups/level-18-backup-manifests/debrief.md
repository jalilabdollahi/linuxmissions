# Backup Manifests: Alert Filter

## What you practiced
- This level focused on **Backup Manifests** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in backup-manifests.log.
