# Mkfs Planning: Alert Filter

## What you practiced
- This level focused on **Mkfs Planning** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in mkfs-planning.log.
