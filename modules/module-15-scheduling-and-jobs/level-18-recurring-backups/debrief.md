# Recurring Backups: Alert Filter

## What you practiced
- This level focused on **Recurring Backups** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in recurring-backups.log.
