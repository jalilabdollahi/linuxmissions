# File Permissions: Script Kickoff

## What you practiced
- This level focused on **File Permissions** in a safe sandbox.
...
- Hint ladder summary: This task usually takes two steps: fix execute permission, then run the script.
