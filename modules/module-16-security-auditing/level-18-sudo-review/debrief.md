# Sudo Review: Alert Filter

## What you practiced
- This level focused on **Sudo Review** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in sudo-review.log.
