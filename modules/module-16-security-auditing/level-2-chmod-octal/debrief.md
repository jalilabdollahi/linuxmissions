# Chmod Octal: Alert Filter

## What you practiced
- This level focused on **Chmod Octal** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in chmod-octal.log.
