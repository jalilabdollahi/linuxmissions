# Journal Errors: Alert Filter

## What you practiced
- This level focused on **Journal Errors** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in journal-errors.log.
