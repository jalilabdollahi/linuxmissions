# Ps Sorting: Alert Filter

## What you practiced
- This level focused on **Ps Sorting** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in ps-sorting.log.
