# Profile D: Alert Filter

## What you practiced
- This level focused on **Profile D** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in profile-d.log.
