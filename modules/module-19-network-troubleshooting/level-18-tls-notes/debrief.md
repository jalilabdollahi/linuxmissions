# Tls Notes: Alert Filter

## What you practiced
- This level focused on **Tls Notes** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in tls-notes.log.
