# Ip Route: Alert Filter

## What you practiced
- This level focused on **Ip Route** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in ip-route.log.
