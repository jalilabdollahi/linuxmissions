# Artifact Layout: Alert Filter

## What you practiced
- This level focused on **Artifact Layout** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in artifact-layout.log.
