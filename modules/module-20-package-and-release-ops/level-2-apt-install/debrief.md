# Apt Install: Alert Filter

## What you practiced
- This level focused on **Apt Install** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in apt-install.log.
