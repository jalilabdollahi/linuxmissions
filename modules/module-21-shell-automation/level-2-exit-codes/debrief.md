# Exit Codes: Alert Filter

## What you practiced
- This level focused on **Exit Codes** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in exit-codes.log.
