# Multiline Fixes: Alert Filter

## What you practiced
- This level focused on **Multiline Fixes** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in multiline-fixes.log.
