# Report Headers: Alert Filter

## What you practiced
- This level focused on **Report Headers** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in report-headers.log.
