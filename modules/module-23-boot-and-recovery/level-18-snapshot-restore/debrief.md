# Snapshot Restore: Alert Filter

## What you practiced
- This level focused on **Snapshot Restore** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in snapshot-restore.log.
