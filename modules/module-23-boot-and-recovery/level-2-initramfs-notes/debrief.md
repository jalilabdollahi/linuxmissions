# Initramfs Notes: Alert Filter

## What you practiced
- This level focused on **Initramfs Notes** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in initramfs-notes.log.
