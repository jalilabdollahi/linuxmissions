# Sysctl Review: Alert Filter

## What you practiced
- This level focused on **Sysctl Review** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in sysctl-review.log.
