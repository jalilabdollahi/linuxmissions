# Xxd Review: Alert Filter

## What you practiced
- This level focused on **Xxd Review** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in xxd-review.log.
