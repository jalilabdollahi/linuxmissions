# Xargs Null: Alert Filter

## What you practiced
- This level focused on **Xargs Null** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in xargs-null.log.
