# Grep Gauntlet: Alert Filter

## What you practiced
- This level focused on **Grep Gauntlet** in a safe sandbox.
...
- Hint ladder summary: Look for a filtering command that keeps only the alert lines in grep-gauntlet.log.
